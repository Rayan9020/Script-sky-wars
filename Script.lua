...
TextBox.PlaceholderText = "حط المفتاح يا زق تلميح مفتاح بسمي..."
TextBox.Text = ""
TextBox.TextSize = 18
...
local function validateKey(key)
    return key == "rayan" -- Replace this with your key
end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Rayan9020/Script-sky-wars/main/Script.lua", true))()
